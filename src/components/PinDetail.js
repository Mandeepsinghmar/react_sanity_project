  ...
  return (
    <div>
      <div className='flex xl:flex-row  flex-col m-auto bg-white gap-8 pb-3 ' style={{ maxWidth: '1016px', borderRadius: '32px' }}>
        <div>
          <img className='rounded-t-3xl rounded-b-lg sm:w-508 w-96 sm:h-685 h-370' src='https://i.pinimg.com/236x/49/ff/bc/49ffbc7d478e9af9165ada48c4cc760f.jpg' alt='user-post' />
        </div>
        <div className='w-96 pt-10 pl-5 pr-4'>
          ...
          <div className='flex gap-2 mt-5 items-center bg-white rounded-lg '>
            <img src='https://i.pinimg.com/236x/6f/d8/e0/6fd8e04bc9620686b6527b70a32b79e7.jpg' className='w-10 h-10 rounded-full' alt='user-profile' />
          ...
          <div className='flex mt-6 gap-3'>
            <img src='https://i.pinimg.com/236x/6f/d8/e0/6fd8e04bc9620686b6527b70a32b79e7.jpg' className='w-10 h-10 rounded-full' alt='user-profile' />
            <input className='border-gray-100 outline-none border-2 p-2 rounded-2xl w-72' type='text' placeholder='Add a comment' />
          </div>
        </div>
      </div>
