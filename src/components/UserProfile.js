...
const imageUrl = 'https://i.pinimg.com/236x/6f/d8/e0/6fd8e04bc9620686b6527b70a32b79e7.jpg';
  ...
  return (
    <div>
      <div className='lg:w-656 m-auto'>
        <div>
          <img className='rounded-lg lg:w-656 h-370 m-auto' src={imageUrl} alt='user-post' />
          <img className='rounded-full w-28 h-28 m-auto -mt-14' src={imageUrl} alt='user-post' />
        </div>
